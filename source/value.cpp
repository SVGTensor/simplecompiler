...
void Value::sqrt(
    ...
    if (!v0.isNumber())
        throw InterpretatorException("Illegal operands of sqrt");
    if (v0.value_type == VALUE_TYPE_INT) {
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::sqrt((double)v0.int_value);
    } else {
        assert(v0.value_type == VALUE_TYPE_DOUBLE);
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::sqrt(v0.double_value);
    }
}
...
void Value::sin(
    ...
    if (!v0.isNumber())
        throw InterpretatorException("Illegal operands of sin");
    if (v0.value_type == VALUE_TYPE_INT) {
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::sin((double)v0.int_value);
    } else {
        assert(v0.value_type == VALUE_TYPE_DOUBLE);
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::sin(v0.double_value);
    }
}
...
void Value::cos(
    ...
    if (!v0.isNumber())
        throw InterpretatorException("Illegal operands of cos");
    if (v0.value_type == VALUE_TYPE_INT) {
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::cos((double)v0.int_value);
    } else {
        assert(v0.value_type == VALUE_TYPE_DOUBLE);
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::cos(v0.double_value);
    }
}
...
void Value::exp(
    ...
    if (!v0.isNumber())
        throw InterpretatorException("Illegal operands of exp");
    if (v0.value_type == VALUE_TYPE_INT) {
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::exp((double)v0.int_value);
    } else {
        assert(v0.value_type == VALUE_TYPE_DOUBLE);
        res.value_type = VALUE_TYPE_DOUBLE;
        res.double_value = std::exp(v0.double_value);
    }
}
...
void Value::pow(
    ...
    if (!v0.isNumber() or !v1.isNumber())
        throw InterpretatorException("Illegal operands of pow");

    res.value_type = VALUE_TYPE_DOUBLE;

    double a, b;
    if (v0.value_type == VALUE_TYPE_INT) {
        a = (double) v0.int_value;
    } else {
        a = v0.double_value;
    }
    if (v1.value_type == VALUE_TYPE_INT) {
        b = (double) v1.int_value;
    } else {
        b = v1.double_value;
    }

    res.double_value = std::pow(a,b);
}
